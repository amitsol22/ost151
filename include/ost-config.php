...
define('SECRET_SALT','mP1KQMaW2TxinSyORKY1VjSb42RY5LQN');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','amitsolanki22@gmail.com');
...
define('DBNAME','ost151');
define('DBUSER','ost151');
define('DBPASS','Ost@151*');
